...
define('_MD_XCCK_ERROR_PAGE_NOT_FOUND', 'Specified parent page not found');
...
define('_MD_XCCK_LANG_VIEW', 'view detail');
...
define('_MD_XCCK_LANG_DEFINITION', 'field definition');
